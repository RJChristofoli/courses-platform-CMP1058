...
const titles: Record<string, { title: string; subtitle: string }> = {
  ...
  '/usuarios': {
    title: 'Usuários e progresso',
    subtitle: 'Pessoas, matrículas e acompanhamento da jornada de aprendizagem.',
  },
  '/financeiro': {
    title: 'Financeiro',
    subtitle: 'Planos, assinaturas e pagamentos em uma mesma visão.',
  },
}
    ...
    <header className="flex flex-col gap-3 rounded-[1.5rem] border border-white/70 bg-white/80 px-4 py-4 shadow-soft backdrop-blur md:flex-row md:items-center md:justify-between">
      ...
      <div className="flex flex-col gap-3 md:w-[24rem] md:flex-row md:items-center md:justify-end">
        <div className="relative flex-1">
          ...
          <Input className="h-9 pl-9" placeholder="Buscar por cursos, usuários ou trilhas" />
        </div>
